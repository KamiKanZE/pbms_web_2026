    ...
    return (
      <>
        <Grid container spacing={1} className="flex">
          ...
          <Grid item xs={3}>
            <Tooltip title="แก้ไข">
              <span className="edit-button-2" onClick={() => this.onEditUser()}>
          ...
          <Grid item xs={5}>
            <Input
              ...
              // placeholder={'ค้นหา' + title}
              onChange={this.handleInputChange}
              value={this.state.department.split(',')[1]}
              style={{ width: '100%' }}
              disabled
            />
          </Grid>
        ...
        <Grid container spacing={1} className="flex">
          <Grid item xs={4} style={{ textAlign: 'right' }}>
            อีเมล (สำหรับ Login เข้าใช้งานระบบ) :
          </Grid>
          <Grid item xs={5}>
            <Input
              type="text"
          ...
          <Grid item xs={3}>
            <Tooltip title="แก้ไข">
              <span className="edit-button-2" onClick={() => this.onEditPass()}>
                <Icon style={{ fontSize: '14px' }}>edit</Icon>
              </span>
            </Tooltip>
          </Grid>
