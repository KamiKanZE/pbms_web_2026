...
export default class PlanList extends React.Component {
  ...
  //       this.setState({
  //         ButgetSources: [
  //           { value: '', display: '(เลือกข้อมูลแหล่งงบประมาณ)' },
  //         ].concat(ButgetSource),
  //       });
  //     })
  //     .catch(error => {
          ...
          <Card className="mb-12">
            <CardBody>
              <Table responsive bordered striped hover id="table1">
                <thead>
                  <tr>
                    <th>รหัสข้อมูลแผนงาน</th>
                    {/* <th>BudgetSouceID</th> */}
                    <th>ชื่อข้อมูลแผนงาน</th>
                    <th />
                  </tr>
                </thead>
                <tbody>
              ...
              >
                ...
                /> */}
                    ...
                    <Col sm={12}>
                      <Input type="select" name="BudgetSouceID">
                    ...
                    {/* <FormGroup>
                      <Label for="PlanID" sm={12}>
                        รหัสข้อมูลแผนงาน <font color="red">*</font>
                      </Label>
                      <Col sm={12}>
                        <Input
                          type="text"
                    ...
                    <FormGroup>
                      <Label for="PlanName" sm={12}>
                        ชื่อข้อมูลแผนงาน <font color="red">*</font>
                      </Label>
                      <Col sm={12}>
                        <Input
                          type="textarea"
