  ...
  return (
    <div>
      ...
      >
        ...
        {/* <MenuItem component={Link} to={'/progress1/' + project_id}>
          รายงานกิจกรรมภายใต้โครงการ
        </MenuItem> */}
      </Menu>
    </div>
  );
...
function ProgressBar({ dataprogress }) {
  ...
  return (
    <Progress color={color} value={dataprogress} className="mt-2">
      {dataprogress}%
    </Progress>
  );
}
...
export default class ProjectList extends React.Component {
  ...
  loadCommentsFromServer() {
    ...
    $.ajax({
      url: this.state.url + this.props.project_id,
      // '?page=' +
      // this.state.selected +
      // '&size=' +
      // this.state.perPage,
