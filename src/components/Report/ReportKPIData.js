...
export default class ReportKPIData extends React.Component {
  constructor(props) {
    super(props);
    let id;
    {
      ...
      <>
        <Row>
          ...
          <Col>
            ...
            <div style={{ display: 'flex', justifyContent: 'right' }}>
              <NavLink
                to={`/ReportActivities/ReportDetail2/${this.state.projectId}`}
              >
                {'ข้อมูลกิจกรรม <<'}
              </NavLink>
              ...
              <NavLink
                to={`/ReportActivities/ReportDetail4/${this.state.projectId}`}
              >
                {'>> ข้อมูลความเสี่ยง'}
              </NavLink>
            </div>
