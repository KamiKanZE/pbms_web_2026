...
export default class KPIDataDetailList2 extends React.Component {
  constructor(props) {
    super(props);
    let id;
    {
    ...
    this.state = {
      ...
      perPage: 10,
      keyword: '',
      url: process.env.REACT_APP_SOURCE_URL + '/kpis/2/kpi',
    };
  }
  toggle = modalType => () => {
    if (!modalType) {
  ...
  loadCommentsFromServer() {
    $.ajax({
      url: this.state.url + '?budget_year=' + this.props.year,
      //   '/page=' +
      //   this.state.selected +
      //   '&size=' +
      //   this.state.perPage +
              ...
              <thead>
                <tr style={{ backgroundColor: '#e0ecfa' }}>
                  ...
                  <th style={{ textAlign: 'left' }}>
                    ชื่อข้อมูลนโยบายนายกเทศมนตรีประจำปี
                  </th>
                    ...
                    .map((id, i) => (
                      <tr key={'table' + i}>
                        ...
                        <td style={{ textAlign: 'center' }}>
                          ...
                          <NavLink
                            to={`/KPIData/KPIDataDetailProject/${this.props.id}/${id._id}/${this.props.year}`}
                          >
                            <Tooltip title="ดูโครงการ">
                              <span
