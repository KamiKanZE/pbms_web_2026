...
import ReportRiskData from '../../components/Report/ReportRiskData';
...
function Report({ page, projectName, projectDetail, revenue_type_category }) {
  ...
  return (
    ...
    >
      <Row>
        <Col>
          <ReportRiskData page={page} title="การรายงานผลปฏิบัติงาน" />
        </Col>
      </Row>
    </ReportProjectPage>
  );
...
export default class ReportDetail4 extends React.Component {
  state = {
    projectName: '',
    projectDetail: {},
