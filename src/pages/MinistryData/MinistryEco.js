...
import MinistryEcoList from '../../components/BasicInformation/MinistryEcoList';
...
function MinistryData({ page }) {
  return (
    ...
    >
      <Row>
        <Col>
          <MinistryEcoList page={page} title="แผนพัฒนาเศรษฐกิจ" />
        </Col>
      </Row>
    </Page2>
  );
...
export default class MinistryEco extends React.Component {
  render() {
