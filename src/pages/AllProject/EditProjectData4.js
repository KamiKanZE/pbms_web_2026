...
import AddProjectRiskData from '../../components/AllProject/AddProjectRiskData';
import EditProjectRiskData from '../../components/AllProject/EditProjectRiskData';
...
function Data({ page, projectName }) {
  return (
    ...
    >
      <Row>
        <Col>
          <EditProjectRiskData page={page} title="โครงการ" />
        </Col>
      </Row>
    </EditProjectPage>
  );
...
export default class EditProjectData4 extends React.Component {
  state = {
    projectName: '',
  };
